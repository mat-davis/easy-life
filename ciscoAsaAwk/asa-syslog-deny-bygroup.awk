# AWK to parse Cisco PIX/ASA syslog for Deny entries (access-group) then display source IP, destination IP, protocol & port (+ headers)
# Created 19/10/2015 by mat-davis
