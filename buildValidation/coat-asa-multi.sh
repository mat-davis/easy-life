...
#********************************************************************************
# Coat2 ASA test script - used for testing device coat for single context ASA
# devices.
#
# Script is a WIP so don't expect perfection!
#
# Version 1.0
...
"********************************************************************************" \
"*                                                                              *" \
"* This computer system is the property of *** Limited.                         *" \
"*                                                                              *" \
...
#2.04
#Validate Current Version matches Standard Version
set testno "2.04"
...
#2.09
#Validate motd banner is to the standard
set testno "2.09"
...
if {$line > 0} {
  if {[regexp -- {domain.com} [lindex $data $line] all ] || [regexp -- {otherdomain.com} [lindex $data $line] all]} {
    set result 1
    set value $all
    printoutput $testno $desc $value $result
  } else {
...
#2.23
#Validate standard interface naming convention
set testno "2.23"
...
#2.24
#Validate standard security level is configured
set testno "2.24"
